        ...
        <div class="signin-signup">
          ...
          >
            ...
            <el-form-item  prop="username">
              ...
              <el-input  v-model="ruleForm.username" clearable class="input-field " placeholder="*用户名"></el-input>
            </el-form-item>
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$http
            .get(
              "http://localhost:8081/user/login?username=" +
                username +
                "&password=" +
                password,
            ...
            .then((res) => {
              if (res.data != "") {
                ...
                // //数据存入userInfo中
                this.$store.commit("userInfo", res.data[0].ID);
                this.$store.commit("userInfo1", res.data[0].USERNAME);
                //将数据存入sessionStorage,页面刷新后数据不会消失
